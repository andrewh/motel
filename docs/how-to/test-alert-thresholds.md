...
Where your pipeline derives metrics determines what error rate motel needs to produce. This is the most common source of confusion when alert tests do not fire as expected.
