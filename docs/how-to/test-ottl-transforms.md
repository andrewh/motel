...
- motel installed
- An OpenTelemetry Collector binary — download `otelcol-contrib` from the [collector releases](https://github.com/open-telemetry/opentelemetry-collector-releases/releases), which includes the `transform` processor
